...
*/
	...
	class corePieModule extends coreBaseModule {
		
		public function run($params=array()) {
			$htc_path = coreResourceLibrary::getFirstFilePath(APP_RESOURCE_TYPE_MODULE, $this->getName(), "/static/PIE.htc");
			$htc_path = coreResourceLibrary::getAbsolutePath($htc_path);
			
			$fsize = filesize($htc_path);
			
			header("Content-Type: text/x-component");
			header("Content-Length: $fsize");
			
			
			copy ($htc_path, 'php://output');
			die();
		}
